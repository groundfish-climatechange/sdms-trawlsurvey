...
```{r}
m <- run_sdmTMB(dat=trawl_roms_utm,spp="yelloweye rockfish",use_depth=T,env_spline=T,include_substrate=F)
summary(m)
```
# Normal QQ plot
...
dev.copy(jpeg,'yelloweyedepth_qq.jpg', width=5, height=5, units='in', res=300)
dev.off()
```
# Spatial Predictions
...
dev.copy(jpeg,'yelloweyedepth_timespace.jpg', width=5, height=6, units='in', res=300)
dev.off()
```
...
dev.copy(jpeg,'pred_yelloweyedepth_space.jpg', width=5, height=6, units='in', res=300)
dev.off()
```
...
dev.copy(jpeg,'yelloweyedepth_residspace.jpg', width=5, height=6, units='in', res=300)
dev.off()
```
