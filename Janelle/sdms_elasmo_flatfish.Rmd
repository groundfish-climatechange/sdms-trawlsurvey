...
```{r}
process_species_model(species='dover sole',incl_depth = T,incl_substrate = T)
```

Pacific sanddab: substrate
```{r}
process_species_model(species='dover sole',incl_depth = F,incl_substrate = T)
```