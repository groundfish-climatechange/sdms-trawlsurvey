...
```{r}
make_six_maps <- function(preds.yelloweye){
  p1 <- map_year(preds.yelloweye,yr_vec=c(1985:2010))+labs(title='baseline')
  p2 <- map_year(preds.yelloweye,yr_vec=c(2050:2060))+labs(title='mid century1')
  p3 <- map_year(preds.yelloweye,yr_vec=c(2060:2070))+labs(title='mid century2')
  p4 <- map_year(preds.yelloweye,yr_vec=c(2070:2080))+labs(title='mid century3')
  p5 <- map_year(preds.yelloweye,yr_vec=c(2080:2090))+labs(title='end of century1')
    p6 <- map_year(preds.yelloweye,yr_vec=c(2090:2100))+labs(title='end of century2')
