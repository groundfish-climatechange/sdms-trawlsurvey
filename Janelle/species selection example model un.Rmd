...
```{r}
run_sdmTMB <- function(dat,spp,use_depth=T,time_vary=F,spatial_field=T,include_substrate=F,hab_spline=F,env_spline=F,spline_k=3){
...
```{r}
m <- run_sdmTMB(dat=trawl_roms_utm,spp="greenstriped rockfish",use_depth=T,env_spline=T,include_substrate=F)
summary(m)
```
...
dev.copy(jpeg,'greendepth_qq.jpg', width=5, height=5, units='in', res=300)
dev.off()
```
# Spatial Predictions
...
dev.copy(jpeg,'greendepth_timespace.jpg', width=5, height=6, units='in', res=300)
dev.off()
```
...
dev.copy(jpeg,'pred_greenfishdepth_space.jpg', width=5, height=6, units='in', res=300)
dev.off()
```
...
dev.copy(jpeg,'greendepth_residspace.jpg', width=5, height=6, units='in', res=300)
dev.off()
```
...
dev.copy(jpeg,'greendepth_annualmap2100.jpg', width=5, height=5, units='in', res=300)
dev.off()
```
...
dev.copy(jpeg,'sablefishdepth_diffmap20252100.jpg', width=5, height=5, units='in', res=300)
dev.off()
