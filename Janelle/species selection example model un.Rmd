...
```{r}
run_sdmTMB <- function(dat,spp,use_depth=T,time_vary=F,spatial_field=F,include_substrate=T,hab_spline=F,env_spline=F,spline_k=3){
...
```{r}
m <- run_sdmTMB(dat=trawl_roms_utm,spp="big skate",use_depth=T,env_spline=T,include_substrate=T)
summary(m)
m
```
...
dev.copy(jpeg,'bigskate1_qq.jpg', width=5, height=5, units='in', res=300)
dev.off()
```
# Spatial Predictions
...
dev.copy(jpeg,'bigskate1_timespace.jpg', width=5, height=6, units='in', res=300)
dev.off()
```
...
dev.copy(jpeg,'pred_bigskate1_space.jpg', width=5, height=6, units='in', res=300)
dev.off()
```
...
dev.copy(jpeg,'bigskate1_residspace.jpg', width=5, height=6, units='in', res=300)
dev.off()
```
...
dev.copy(jpeg,'bigskate1_annualmap2025.jpg', width=5, height=5, units='in', res=300)
dev.off()
```
...
dev.copy(jpeg,'longnoseskate1_diffmap20252100.jpg', width=5, height=5, units='in', res=300)
dev.off()
