...
```{r}
m <- run_sdmTMB(dat=trawl_roms_utm,spp="chilipepper rockfish",use_depth=F,env_spline=T,include_substrate=T)
summary(m)
```
...
dev.copy(jpeg,'curlfin1_qqe.jpg', width=5, height=6, units='in', res=300)
dev.off()
```
...
dev.copy(jpeg,'curlfin1_timespace.jpg', width=5, height=6, units='in', res=300)
dev.off()
...
dev.copy(jpeg,'pred_curlfin1_space.jpg', width=5, height=6, units='in', res=300)
dev.off()
...
resids_space
dev.copy(jpeg,'curlfin1_space.jpg', width=5, height=6, units='in', res=300)
dev.off()
```
