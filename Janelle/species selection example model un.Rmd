...
```{r}
m <- run_sdmTMB(dat=trawl_roms_utm,spp="sablefish",use_depth=T,env_spline=T,include_substrate=F)
summary(m)
```
...
dev.copy(jpeg,'sablefishsepth_qq.jpg', width=5, height=5, units='in', res=300)
dev.off()
```
# Spatial Predictions
...
dev.copy(jpeg,'sablefishdepth_timespace.jpg', width=5, height=6, units='in', res=300)
dev.off()
```
...
dev.copy(jpeg,'pred_sablefishdepth_space.jpg', width=5, height=6, units='in', res=300)
dev.off()
```
...
dev.copy(jpeg,'sablefishdepth_residspace.jpg', width=5, height=6, units='in', res=300)
dev.off()
```
...
dev.copy(jpeg,'sablefishdepth_annualmap2100.jpg', width=5, height=5, units='in', res=300)
dev.off()
```
