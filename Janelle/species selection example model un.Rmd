...
```{r}
run_sdmTMB <- function(dat,spp,use_depth=T,time_vary=F,spatial_field=T,include_substrate=T,hab_spline=F,env_spline=F,spline_k=3){
...
```{r}
m <- run_sdmTMB(dat=trawl_roms_utm,spp="longnose skate",use_depth=T,env_spline=T)
summary(m)
```
