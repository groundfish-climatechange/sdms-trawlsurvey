# Pull trawl data
# Adopted from FATE spatial indicators project
# Use nwfscSurvey package to pull trawl data
...
spec_names = read_rds(here('data','trawl','nwfsc_species_lookup.rds'))

catch = read_rds(here('data','trawl','wcbts_catch_2019-08-01.rds'))
...
haul = read_rds(here('data','trawl','wcbts_haul_2019-08-01.rds'))
...
spp_to_keep = keep[-grep(spp_to_keep,keep)] %>% as.character()
...
write_rds(dat, here('data','nwfsc_trawl_data.rds'))
