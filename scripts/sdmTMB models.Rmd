...
```{r}
sablefish_models <- crossing(spp="sablefish",spatial_field=c(F,T),hab_spline=c(F,T),env_spline=c(F,T)) %>%
...
```{r}
sablefish_models <- sablefish_models %>% 
