...
# write_rds(ls_ens,here('model output','dts paper','thornyheads_ensemble_preds_ipsl.rds'))
```
...
ls_ens<-read_rds(here('model output','dts paper','thornyheads_ensemble_preds_ipsl.rds'))
```
...
# ggsave(here('model output','dts paper','thornyhead_ensemble_index_ipsl.png'),lsind,h=6,w=8)
```

![](`here('model output','dts paper','dover_ensemble_index_ipsl.png')`)
