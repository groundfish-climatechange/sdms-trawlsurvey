...
fig_dist_depth_change<-plot_grid(four_spp_dist_to_shore_change+theme(plot.margin=unit(c(0.5,0.5,1.5,0.5),'cm'))+guides(color='none',fill='none'),
                                 fourspp_depth_plot + guides(color='none',fill='none') + theme(plot.margin=unit(c(0.5,0.5,1.5,0.5),'cm')),
                                 nrow=1,labels='auto')
